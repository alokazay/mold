                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @foreach($cat->Handbooks as $Handbook)
                                                        ...
                                                        @if($loop->last)
                                                            <a class="delete{{$Handbook->id}}"
                                                               href="">{{$Handbook->name}}</a>
                                                        @else
                                                            <a class="delete{{$Handbook->id}}"
                                                               href="">{{$Handbook->name}}</a><span
                                                                class="delete{{$Handbook->id}}">,</span>
                                                        @endif
                                                    @endforeach
                                                </td>
                                                <td>
                                                    <div class="input-group input-group-sm mb-5">
                                                        ...
                                                        <span style="cursor: pointer;" onclick="add_handbook({{$cat->id}})"
...
<script>
    function deleteHandbook(id) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.get('{{url('/')}}/handbooks/delete?id=' + id);
                $('.delete' + id).remove();
    ...
    function add_handbook(cat_id) {
        ...
        $.get('{{url('/')}}/handbooks/add?cat_id=' + cat_id + '&name=' + name, function () {
            location.reload();
        });
    }
