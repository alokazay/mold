...
<div class="d-flex flex-column flex-root">
    ...
    <!--begin::Wrapper-->
        <div class="wrapper d-flex flex-column flex-row-fluid" id="kt_wrapper">
            ...
            @include('includes.TOP_RIGHT_Toolbar')
            <!--begin::Post-->
                                                ...
                                                <div class="col-6">
                                                    ...
                                                    <div class="bg-gray-100 bg-opacity-70 rounded-2 px-6 py-5">
                                                        ...
                                                        <div class="m-0">
                                                            ...
                                                            <!--begin::Desc-->
                                                            <span
                                                                class="text-gray-500 fw-bold fs-6">Hours Learned</span>
                                                            <!--end::Desc-->
                                                        </div>
                                                        <!--end::Stats-->
                                                    </div>
                                        ...
                                        <div id="kt_sliders_widget_1_slider"
                                            ...
                                            <div class="card-header pt-5">
                                                ...
                                                <h4 class="card-title d-flex align-items-start flex-column">
                                                    <span
                                                        class="card-label fw-bolder text-gray-800">Today’s Course</span>
                                    ...
                                    <div class="col-xl-6 mb-5 mb-xl-10">
                                        ...
                                        <div id="kt_sliders_widget_2_slider"
                                            ...
                                            <div class="card-header pt-5">
                                                ...
                                                <h4 class="card-title d-flex align-items-start flex-column">
                                                    <span
                                                        class="card-label fw-bolder text-gray-800">Today’s Events</span>
                                        ...
                                        <div class="d-flex flex-stack">
                                            ...
                                            <div class="d-flex align-items-center me-3">
                                                ...
                                                <div class="flex-grow-1">
                                                    ...
                                                    <!--begin::Description-->
                                                    <span
                                                        class="text-gray-400 fw-bold d-block fs-6">PHP Framework</span>
                                                    <!--end::Description=-->
                                                </div>
                                                <!--end::Section-->
                                            </div>
                                        ...
                                        <div class="d-flex flex-stack">
                                            ...
                                            <div class="d-flex align-items-center me-3">
                                                ...
                                                <div class="flex-grow-1">
                                                    ...
                                                    <!--begin::Description-->
                                                    <span
                                                        class="text-gray-400 fw-bold d-block fs-6">CSS Framework</span>
                                                    <!--end::Description=-->
                                                </div>
                                                <!--end::Section-->
                                            </div>
                                        ...
                                        <div class="d-flex flex-stack">
                                            ...
                                            <div class="d-flex align-items-center me-3">
                                                ...
                                                <div class="flex-grow-1">
                                                    ...
                                                    <!--begin::Description-->
                                                    <span
                                                        class="text-gray-400 fw-bold d-block fs-6">Java Framework</span>
                                                    <!--end::Description=-->
                                                </div>
                                                <!--end::Section-->
                                            </div>
                                        ...
                                        <div class="d-flex flex-stack">
                                            ...
                                            <div class="d-flex align-items-center me-3">
                                                ...
                                                <div class="flex-grow-1">
                                                    ...
                                                    <!--begin::Description-->
                                                    <span
                                                        class="text-gray-400 fw-bold d-block fs-6">Better Tooling</span>
                                                    <!--end::Description=-->
                                                </div>
                                                <!--end::Section-->
                                            </div>
