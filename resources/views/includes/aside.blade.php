...
<path opacity="0.3"
      ...
      fill="currentColor"/>
                    ...
                    <div class="menu-item">
                        <a class="menu-link  @if (Request::is('*leads*') ) active @endif"
                           href="{{url('/')}}/leads">
										<span class="menu-icon">
 <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
<path
...
<path opacity="0.3"
      ...
      fill="currentColor"/>
                            ...
                            <span class="menu-title">Лиды</span>
                        </a>
                    </div>
                    <div class="menu-item">
                    ...
                    <div class="menu-item">
                        <a class="menu-link  @if (Request::is('*fields-mutation*') ) active @endif"
                           href="{{url('/')}}/fields-mutation">
                           <span class="menu-icon">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                <path
                                    d="M20 14H18V10H20C20.6 10 21 10.4 21 11V13C21 13.6 20.6 14 20 14ZM21 19V17C21 16.4 20.6 16 20 16H18V20H20C20.6 20 21 19.6 21 19ZM21 7V5C21 4.4 20.6 4 20 4H18V8H20C20.6 8 21 7.6 21 7Z"
                            ...
                            <span class="menu-title">История изменения</span>
                        </a>
                    </div>
